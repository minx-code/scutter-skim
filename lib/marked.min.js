...
`),
                    ...
                    let y = null,
                        ee;
                    (this.options.gfm &&
                        ((y = this.rules.other.listIsTask.exec(u)), y && ((ee = y[0] !== '[ ] '), (u = u.replace(this.rules.other.listReplaceTask, '')))),
                        i.items.push({
                            type: 'list_item',
                            raw: p,
                            task: !!y,
                                    ...
                                    (r ? r.unshift(i.tokenizer) : (t[i.level] = [i.tokenizer]),
                                        i.start &&
                                            (i.level === 'block'
                                                ...
                                                : i.level === 'inline' && (t.startInline ? t.startInline.push(i.start) : (t.startInline = [i.start]))));
                                }
